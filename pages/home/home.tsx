  ...
  return (
    <div className={styles.homeContainer}>
      <Head>
        ...
        />
        <meta name="author" content="Daniel Brunat" />
        <meta name="keywords" content="Daniel, Brunat, Portfolio, Frontend" />
        <meta
          property="og:image"
        ...
        <div className={styles.intro}>
          <div className={styles.introduction}>
            ...
            <div className={styles.profilePicture}>
              <Image
                alt="Profile picture of Daniel Brunat."
                src={profilePicture}
              />
            </div>
          </div>
